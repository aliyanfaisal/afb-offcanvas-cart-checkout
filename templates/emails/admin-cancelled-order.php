...
if (!$plain_text) {
    echo '<p style="margin:0 0 16px; font-family: Helvetica, Arial, sans-serif;">' . esc_html__('An order was cancelled. Details below:', 'woocommerce') . '</p>';
}

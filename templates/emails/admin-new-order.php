...
if (!$plain_text) {
    echo '<p style="margin:0 0 16px; font-family: \"Helvetica Neue\", Helvetica, Roboto, Arial, sans-serif;">' . esc_html__('A new order has been placed. Details below:', 'woocommerce') . '</p>';
}
...
// Replace default customer details action with a custom addresses block to avoid shipping section

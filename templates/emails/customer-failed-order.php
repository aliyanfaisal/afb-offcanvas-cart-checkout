...
if (!$plain_text) {
    echo '<p style="margin:0 0 16px; font-family: Helvetica, Arial, sans-serif;">' . esc_html__('Your order has failed. Here are the details:', 'woocommerce') . '</p>';
}
...
if ($plain_text) {
    ...
    foreach ($order->get_items() as $item_id => $item) {
        ...
        // Left column: Align Start ($text_align)
        ...
        echo '</tr></tbody></table>';
        echo '</td>';
        // Unit Price: Align End ($text_align_end)
        ...
        echo '</td>';
        // Total: Align End ($text_align_end)

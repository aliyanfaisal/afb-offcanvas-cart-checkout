...
if (!$plain_text) {
    echo '<p style="margin:0 0 16px; font-family: \"Helvetica Neue\", Helvetica, Roboto, Arial, sans-serif;">' . esc_html__('Order details and payment information:', 'woocommerce') . '</p>';
}

...
if (!$plain_text) {
    echo '<p style="margin:0 0 16px; font-family: \"Helvetica Neue\", Helvetica, Roboto, Arial, sans-serif;">' . esc_html__('We are processing your order. Details below:', 'woocommerce') . '</p>';
}
...
if ($plain_text) {
    ...
    // Totals similar to Woo template
...
// Early pickup info output to avoid downstream variable overrides
// Remove early pickup debug blocks; pickup info will render within addresses block below
...
// Keep pickup meta as-is; no debug output

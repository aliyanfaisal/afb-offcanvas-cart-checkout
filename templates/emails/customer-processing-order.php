...
/**
 * Custom Customer Processing Order Email
 */
...
if (!$plain_text) {
    echo '<p style="margin:0 0 16px; font-family: Helvetica, Arial, sans-serif;">' . esc_html__('We are processing your order. Details below:', 'woocommerce') . '</p>';
}
...
if ($plain_text) {
    ...
    if ($delivery_option === 'pickup' && $pickup_location) {
        ...
        // Standard Output: Align Start ($text_align)
